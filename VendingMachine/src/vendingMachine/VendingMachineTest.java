...
//		vm = new VendingMachine();  didn't work for me
	...
	@Test
	void testItemClass() {		
		Item item = vm.new Item("Name", "Type", 0.75);
	...
	void testItemRowClass() {		
		Item item = vm.new Item("Name", "Type", 0.75);
		ItemRow itemc = vm.new ItemRow("Name", "Type", 0.75, 1, "@1");
		...
		assertEquals(item, match.vendItem(), "ItemCount vendItem() vends correct item fails");
...
//@ do null tests
		...
		ItemRow ic1 = vm.new ItemRow("Name", "Type", 0.25, 1, "@1");
		ItemRow ic2 = vm.new ItemRow("Name2", "Type", 0.25, 1, "@1");
		ItemRow ic3 = vm.new ItemRow("Name3", "Type", 0.50, 1, "@2");
		ItemRow ic4 = vm.new ItemRow("Name3", "Type", 0.50, 1, "@2");  // duplicate row
	...
	void testDoLabel() {
		ItemRow ic1 = vm.new ItemRow("Name", "Type", 0.25, 1, "@1");
		ItemRow ic2 = vm.new ItemRow("Name2", "Type", 0.50, 1, "@2");
		ItemRow ic3 = vm.new ItemRow("Name3", "Type", 0.50, 1, "@3");
